...
{
	private static Stemmer instence;

	public static Stemmer getInstance()
	{
		if (instence == null)
			instence = new Stemmer();
		return instence;
	}
	...
	private boolean cvc(String str)
	{
		...
		if ((!vowel(str.charAt(length - 1), str.charAt(length - 2))) && (str.charAt(length - 1) != 'w') && (str.charAt(length - 1) != 'x') && (str.charAt(length - 1) != 'y')
	...
	private String step2(String str)
	{
		...
		String[][] suffixes = { { "ational", "ate" }, { "tional", "tion" }, { "enci", "ence" }, { "anci", "ance" }, { "izer", "ize" }, { "iser", "ize" }, { "abli", "able" }, { "alli", "al" },
				{ "entli", "ent" }, { "eli", "e" }, { "ousli", "ous" }, { "ization", "ize" }, { "isation", "ize" }, { "ation", "ate" }, { "ator", "ate" }, { "alism", "al" }, { "iveness", "ive" },
	...
	private String step3(String str)
	{
		...
		String[][] suffixes = { { "icate", "ic" }, { "ative", "" }, { "alize", "al" }, { "alise", "al" }, { "iciti", "ic" }, { "ical", "ic" }, { "ful", "" }, { "ness", "" } };
		NewString stem = new NewString();
	...
	{
		String[] strings = new String[] { "the", "stop", "word", "elimination", "process", "is", "improved", "by", "splitting", "combined", "words" };
		for (int i = 0; i < strings.length; i++)
			System.out.println(Stemmer.getInstance().getStem(strings[i]));
	}
